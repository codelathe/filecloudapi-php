...
class GetMetadataSetDefinitionsTest extends TestCase
{
    public function testGetAllMetadataSetDefinitions()
    {
        ...
        $cloudApiMock
            ->expects($this->any())
            ->method('doPost')
            ->with("$serverUrl/admin/getmetadatasetdefinitions", http_build_query([
                'keyword' => '',
                'start' => 0,
                'end' => 0,
            ]))
        ...
        $metadataSets = $cloudApiMock->getMetadataSetDefinitions();
